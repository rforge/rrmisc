...
# xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx xx
#
tempDirFigures <- file.path(tempdir(), "TmpDir_zu_loeschen")
...
if (LenCurAttr > 0) {
  ...
  for (j in 1:NPartsUebers)
  {
    ...
    pfilen     <- file.path(tempDirFigures, paste0("PlotUebers", CurNpartsUebers, ".png"))
    png(filename = pfilen
...
if (LenCurAttr > 0) {
  ...
  for (j in 1:NPartsChar)
  {
    ...
    pfilen   <- file.path(tempDirFigures, paste0("PlotChar", CurNpartsChar, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotChar)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsNum)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotNum", CurNpartsNum, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotNum)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsWerteBerNum)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotWerteBerNum", CurNpartsNum, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotNum)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsInt)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotInt", CurNpartsInt, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotInt)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsWerteBerInt)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotWerteBerInt", CurNpartsInt, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotInt)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsCharLikeNum)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotCharLikeNum", CurNpartsCharLikeNum, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsWerteBerCharLikeNum)
  {
    ...
    pfilen  <- file.path(tempDirFigures, paste0("PlotWerteBerCharLikeNum", CurNpartsCharLikeNum, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotCharLikeNum)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsFactor)
  {
    ...
    pfilen     <- file.path(tempDirFigures, paste0("PlotFactor", CurNpartsFactor, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotFactor)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsDate)
  {
    ...
    pfilen   <- file.path(tempDirFigures, paste0("PlotDate", CurNpartsDate, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotDate)
...
if (length(CurAttr0) > 0) {
  ...
  for (j in 1:NPartsWerteBerDate)
  {
    ...
    pfilen   <- file.path(tempDirFigures, paste0("PlotWerteBerDate", CurNpartsDate, ".png"))
    png(filename = pfilen
        , width = 9, height = GPars[1], units = "in"
        , res = 300)
    print(PlotDate)

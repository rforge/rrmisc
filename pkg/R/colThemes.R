...
div02.theme <- function (...) {
    ...
    div02 <- rgb(red=div02.rgb[seq(1, 16, 3)],
    ...
    div02.theme <- simpleTheme(col=div02,
                               col.line=div02, #[1],
                               alpha=1,
                               pch=16,
                               lwd=1,
...
div03.theme <- function (...) {
    ...
    div03 <- rgb(red=div03.rgb[seq(1, 25, 3)],
    ...
    div03.theme <- simpleTheme(col=div03,
                               col.line=div03, #[1],
                               alpha=1,
                               pch=16,
                               lwd=1,
...
qual01.theme <- function (...) {
    ...
    qual01 <- rgb(red=qual01.rgb[seq(1, 34, 3)],
    ...
    qual01.theme <- simpleTheme(col=qual01,
                               col.line=qual01, #[1],
                               alpha=1,
                               pch=16,
                               lwd=1,
...
qual02.theme <- function (...) {
    ...
    qual02 <- rgb(red=qual02b.rgb[seq(1, 16, 3)],
    ...
    qual02.theme <- simpleTheme(col=qual02,
                               col.line=qual02, #[1],
                               alpha=1,
                               pch=16,
                               lwd=1,

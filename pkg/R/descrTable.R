...
#' @param var.list A data frame for the mapping of the variable names to
#' meaningful labels. The attribute 'var_name' for the variable names in d.data
#' and 'var_label' for the labels.
